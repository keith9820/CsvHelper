...
namespace CsvHelper.TypeConversion
{
	...
	public class ByteConverter : DefaultTypeConverter
	{
        ...
        /// </summary>
        public ByteConverter(NumberStyles UseNumberStyles)
        {
        ...
        /// Customizable constructor
        /// </summary>
        public ByteConverter(CultureInfo UseCultureInfo, NumberStyles UseNumberStyles)
        {
            UsingNumberStyles = UseNumberStyles;
        ...
        /// Customizable constructor
        /// </summary>
        public ByteConverter(CultureInfo UseCultureInfo)
        {
            UsingCultureInfo = UseCultureInfo;
        }
		...
		{
			byte b;
            if (byte.TryParse(text, UsingNumberStyles, UsingCultureInfo ?? culture, out b))
			{
				return b;
			}
