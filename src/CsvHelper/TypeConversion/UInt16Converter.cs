...
namespace CsvHelper.TypeConversion
{
	...
	public class UInt16Converter : DefaultTypeConverter
	{
        ...
        /// </summary>
        public UInt16Converter(NumberStyles UseNumberStyles)
        {
        ...
        /// Customizable constructor
        /// </summary>
        public UInt16Converter(CultureInfo UseCultureInfo, NumberStyles UseNumberStyles)
        {
            UsingNumberStyles = UseNumberStyles;
        ...
        /// Customizable constructor
        /// </summary>
        public UInt16Converter(CultureInfo UseCultureInfo)
        {
            UsingCultureInfo = UseCultureInfo;
        }
		...
		{
			ushort us;
            if (ushort.TryParse(text, UsingNumberStyles, UsingCultureInfo ?? culture, out us))
			{
				return us;
			}
