...
namespace CsvHelper.TypeConversion
{
	...
	public class Int32Converter : DefaultTypeConverter
	{
        ...
        /// </summary>
        public Int32Converter(NumberStyles UseNumberStyles)
        {
        ...
        /// Customizable constructor
        /// </summary>
        public Int32Converter(CultureInfo UseCultureInfo, NumberStyles UseNumberStyles)
        {
            UsingNumberStyles = UseNumberStyles;
        ...
        /// Customizable constructor
        /// </summary>
        public Int32Converter(CultureInfo UseCultureInfo)
        {
            UsingCultureInfo = UseCultureInfo;
        }
		...
		{
			int i;
            if (int.TryParse(text, UsingNumberStyles, UsingCultureInfo ?? culture, out i))
			{
				return i;
			}
