...
namespace CsvHelper.TypeConversion
{
	...
	public class Int16Converter : DefaultTypeConverter
	{
        ...
        /// </summary>
        public Int16Converter(NumberStyles UseNumberStyles)
        {
        ...
        /// Customizable constructor
        /// </summary>
        public Int16Converter(CultureInfo UseCultureInfo, NumberStyles UseNumberStyles)
        {
            UsingNumberStyles = UseNumberStyles;
        ...
        /// Customizable constructor
        /// </summary>
        public Int16Converter(CultureInfo UseCultureInfo)
        {
            UsingCultureInfo = UseCultureInfo;
        }
		...
		{
			short s;
            if (short.TryParse(text, UsingNumberStyles, UsingCultureInfo ?? culture, out s))
			{
				return s;
			}
